...
def filename_clean(leg):
    return "1_clean_data/L"+str(leg)+".csv"
def filename_lyapunov(leg):
    return store_clean_data(leg)+"lyapunovdata.csv"
def store_clean_data(leg):
    return "2_results/leg"+str(leg)+"/"+str(leg)+"_"